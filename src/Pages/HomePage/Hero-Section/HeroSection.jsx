...
export default function HeroSection() {
  return (
    <div>
      ...
      >
        <SwiperSlide>
          <div className="hero bg-gradient-red text-white h-[80vh] xl:py-16 lg:py-16 md:py-10 sm:py-8 py-4">
            <div className="hero-content text-center ">
              <div className="max-w-xl">
                <h4 className="xl:text-6xl lg:text-6xl md:text-5xl sm:text-4xl text-3xl font-bold py-8 move-up">
                  👋
                </h4>
        ...
        <SwiperSlide>
          <div className="hero bg-gradient-blue text-white h-[80vh] xl:py-16 lg:py-16 md:py-10 sm:py-8 py-4">
            <div className="hero-content text-center ">
              <div className="max-w-xl ">
                <h4 className="xl:text-6xl lg:text-6xl md:text-5xl sm:text-4xl text-3xl font-bold py-8 move-up">
                  🛒
        ...
        <SwiperSlide>
          <div className="hero bg-gradient-green text-white h-[80vh] xl:py-16 lg:py-16 md:py-10 sm:py-8 py-4">
